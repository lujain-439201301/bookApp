...
public class cart extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interface_title.setText(getString(R.string.my_cart));
...
*/
    ...
    public void removeItem(Cart cart) {
        alert.showMessageOKCancel(getString(R.string.remove_cart_question), new DialogInterface.OnClickListener() {
            @Override
