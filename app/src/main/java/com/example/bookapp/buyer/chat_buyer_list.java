...
import com.example.bookapp.seller.chat_seller_list;
import com.google.android.material.navigation.NavigationView;


public class chat_buyer_list extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        javaScriptReceiver = new JavaScriptReceiver(chat_buyer_list.this);
        webView.addJavascriptInterface(javaScriptReceiver, "JSReceiver");
        String buyer_id = session.getUserID();

        String url = URLs.CHATLIST +"?userType=st&buyer_id="+buyer_id;
        webView.loadUrl(url);
